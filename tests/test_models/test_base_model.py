...
class TestBaseModel(unittest.TestCase):
    ...
    def test_instance(self):
        ...
        base_1 = BaseModel()
        self.assertTrue(isinstance(base_1, BaseModel))
        self.assertTrue(type(base_1), BaseModel)
        self.assertTrue(isinstance(base_1, object))

    def test_attributes(self):
        """To test the BaseModel attibutes are instantiated"""
        base_1 = BaseModel()
        expected_id = "{}\n".format(base_1.id)
        expected_updated_at = "{}\n".format(base_1.updated_at)
        expected_created_at = "{}\n".format(base_1.created_at)
    ...
    def test_attributes_types(self):
        ...
        base_1 = BaseModel()
        self.assertEqual(type(base_1.id), str)
        self.assertEqual(type(base_1.created_at), datetime)
        self.assertEqual(type(base_1.updated_at), datetime)

    def test_save(self):
        """Tests if an instance is updated with a new time"""
        base_1 = BaseModel()
        base_1.save()
        self.assertNotEqual(base_1.created_at, base_1.updated_at)

    def test_to_dict(self):
        """Tests if an instance is converted to dict"""
        base_1 = BaseModel()
        base_1_dict = base_1.to_dict()
    ...
    def test_str(self):
        ...
        base_1 = BaseModel()
        expected = "[BaseModel] ({}) {}\n".format(base_1.id, base_1.__dict__)
    ...
    def test_kwargs(self):
        ...
        base_1 = BaseModel()
        base_1_json = base_1.to_dict()
        base_1_new = BaseModel(**base_1_json)
        self.assertFalse(base_1 is base_1_new)
